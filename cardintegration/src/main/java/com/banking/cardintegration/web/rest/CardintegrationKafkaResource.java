...
@RestController
@RequestMapping("/api/cardintegration-kafka")
public class CardintegrationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CardintegrationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public CardintegrationKafkaResource(KafkaProperties kafkaProperties) {
