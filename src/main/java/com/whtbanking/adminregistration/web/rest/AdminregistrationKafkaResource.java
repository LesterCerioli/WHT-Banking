...
@RestController
@RequestMapping("/api/adminregistration-kafka")
public class AdminregistrationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AdminregistrationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public AdminregistrationKafkaResource(KafkaProperties kafkaProperties) {
